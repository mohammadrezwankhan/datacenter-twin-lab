...
Use the smallest public channel that fits the question:

- For a reproducible bug or numerical mismatch, open the [bug/reproducibility issue form](https://github.com/mohammadrezwankhan/datacenter-twin-lab/issues/new?template=bug-reproducibility.yml).
- For a first-run problem, use the [first-run issue form](https://github.com/mohammadrezwankhan/datacenter-twin-lab/issues/new?template=first-run.yml).
...
This project does not provide facility operations support, equipment selection, uptime guarantees, certification, legal advice, or physical-control instructions. Issues and Discussions are public unless the selected channel says otherwise; remove secrets and private data before posting.
